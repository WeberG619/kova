...
## Title
Show HN: Recal – I gave AI persistent memory that learns from corrections (400 lines, zero deps)
...
MCP is free. Agents are free. The missing piece — memory that learns from mistakes — should be free too. Today I'm open-sourcing it as Recal — a 400-line Python library with zero dependencies (just SQLite).

**What makes it different from Mem0, Engram, etc.:**

Most memory systems do Store → Recall. That's it. Recal does five things:
